...
describe("E2E app tests", () => {
  ...
  describe("auth enforcement", () => {
    ...
    it("mounts the protected PSAI-245 Gate 2 one-call endpoint", async () => {
      const res = await app.request(
    ...
    it("mounts the protected PSAI-245 resume-27 endpoint", async () => {
      const res = await app.request(
        "/api/v1/admin/achieve-welcome-call-qa/backfill/resume-27",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({}),
